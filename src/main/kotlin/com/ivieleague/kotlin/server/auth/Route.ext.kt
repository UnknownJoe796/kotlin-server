...
fun Route.restLogin(schema: Schema, userTableAccess: UserTableAccess, usernameScalar: Scalar) {
    post {
        exceptionWrap {
            ...
            val result = userTableAccess.login(schema, usernameScalar, email, password)
